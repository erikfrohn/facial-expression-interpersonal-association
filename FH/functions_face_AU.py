...
def get_AU(path_to_analysis_folder, participant_id): 
    ...
    openface_path = r"C:\Users\hoekstraf\OneDrive - TNO\Team\Work\Analysis HyPyp\Facial expressions (Femke)\OpenFace_2.2.0_win_x64\OpenFace_2.2.0_win_x64\FeatureExtraction.exe"  # Update this path accordingly
    ...
    for index, row in frame_data_csv.iterrows():
        name = row['name']
        input_avi_file = f"pp{participant_id}_{role}_{name}_reconstructed_video_no_black.avi"
